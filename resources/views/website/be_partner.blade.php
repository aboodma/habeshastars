        ...
        <div class="form-group row ">
            <div class="col-md-6 offset-md-4">
                ...
                <div class="from-group row mb-0" >
                    <div class=" col-md-6 offset-md-4" >
                        <p>{{__('By signing up you agree to')}} {{website_settings('website_name')}} <a href="{{route('pages.show',App\Page::find(website_settings('provider_contract'))->slug)}}"> {{__('terms of service  and Privacy Policy')}}</a></p>
