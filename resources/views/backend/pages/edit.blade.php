                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="locale" id="">
                            ...
                            @foreach($languages as $lang)
                                <option @if($page->locale == $lang->locale) selected @endif value="{{$lang->locale}}"> {{$lang->name}} </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea name="content" class="form-control" id="editor" cols="30" rows="20" >{{$page->content}}</textarea>
                    </div>
